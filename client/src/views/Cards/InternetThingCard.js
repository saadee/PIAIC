...
function Card(props) {
  ...
  return (
    <div className='mymainCard ' onMouseOver={() => {
      ...
      <strong className={state.hovered ? " hide-original" : "show-original IA-heading"}> Internet of Things and AI</strong>
{/* 
      ...
      <div className={state.hovered ? "course-outline animated fadeIn " : "animated fadeOut"}>
          ...
          <div className='on-hover-inDiv'>
            <h3 className='on-hover-heading'>Internet Of Things and AI</h3>
